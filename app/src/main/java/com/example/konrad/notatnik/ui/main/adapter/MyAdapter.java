...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    private static ArrayList<StorageTask> mAddedTaskArrayList = new ArrayList<>();
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    listener.onItemClick(mAddedTaskArrayList.get(position));
                }
            });
    ...
    public interface OnItemClickListener{
        void onItemClick(StorageTask storagetask);
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        //holder.mModificationTextView.setText(mAddedTaskArrayList.get(position).getmDescription());
        holder.mModificationTextView.setText(Integer.toString(mAddedTaskArrayList.get(position).getmOwn_ID()));
    }
